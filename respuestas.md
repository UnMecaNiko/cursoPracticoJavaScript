...
También existe el condicional ternario:     (condicion)? (si verdadero):(si falso)
...
//tiposDeSuscripciones.free = tiposDeSuscripciones['free']
...
javaScript imprime siempre en consola lo que devuelve la función, si no hay return el resultado es undefinied
